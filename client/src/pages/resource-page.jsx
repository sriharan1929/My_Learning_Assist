...
function makeDefaults(fields, item) { return Object.fromEntries(fields.map(field => [field.name, item?.[field.name] ?? (field.type === "checkbox" ? false : field.type === "number" ? field.name === "target" ? 100 : field.name === "duration" ? 25 : field.name === "confidence" ? 1 : 0 : field.type === "tags" ? "" : field.options?.[0] || "")]).map(([key, value]) => [key, key === "tags" && Array.isArray(value) ? value.join(", ") : value])); }
